...
pub struct ListRepository<'a> {
    table: Box<dyn ListTable + 'a>,
    transaction: &'a Transaction,
}

impl<'a> ListRepository<'a> {
    pub fn new(table: Box<dyn ListTable + 'a>, transaction: &'a Transaction) -> Self {
        ListRepository { table, transaction }
    }
...
pub struct ListRepositoryRO<'a> {
    table: Box<dyn ListTableRO + 'a>,
}
impl<'a> ListRepositoryRO<'a> {
    pub fn new(table: Box<dyn ListTableRO + 'a>) -> Self {
        ListRepositoryRO { table }
    }
    pub fn get(&self, id: &EntityId) -> Result<Option<List>, RepositoryError> {
        self.table.get(id)
    }
