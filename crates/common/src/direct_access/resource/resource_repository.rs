...
pub struct ResourceRepository<'a> {
    table: Box<dyn ResourceTable + 'a>,
    transaction: &'a Transaction,
}

impl<'a> ResourceRepository<'a> {
    pub fn new(table: Box<dyn ResourceTable + 'a>, transaction: &'a Transaction) -> Self {
        ResourceRepository { table, transaction }
    }
...
pub struct ResourceRepositoryRO<'a> {
    table: Box<dyn ResourceTableRO + 'a>,
}
impl<'a> ResourceRepositoryRO<'a> {
    pub fn new(table: Box<dyn ResourceTableRO + 'a>) -> Self {
        ResourceRepositoryRO { table }
    }
    pub fn get(&self, id: &EntityId) -> Result<Option<Resource>, RepositoryError> {
        self.table.get(id)
    }
