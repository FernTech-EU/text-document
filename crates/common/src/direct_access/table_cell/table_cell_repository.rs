...
use crate::direct_access::table::TableRelationshipField;
...
pub struct TableCellRepository<'a> {
    table: Box<dyn TableCellTable + 'a>,
    transaction: &'a Transaction,
}

impl<'a> TableCellRepository<'a> {
    pub fn new(table: Box<dyn TableCellTable + 'a>, transaction: &'a Transaction) -> Self {
        TableCellRepository { table, transaction }
    }
    ...
    pub fn create_orphan(
        ...
        event_buffer.push(Event {
            origin: Origin::DirectAccess(DirectAccessEntity::TableCell(EntityEvent::Created)),
            ids: vec![new.id],
            data: None,
        });
        Ok(new)
    ...
    pub fn get(&self, id: &EntityId) -> Result<Option<TableCell>, RepositoryError> {
        self.table.get(id)
    }
    pub fn get_multi(&self, ids: &[EntityId]) -> Result<Vec<Option<TableCell>>, RepositoryError> {
        self.table.get_multi(ids)
    }
    pub fn get_all(&self) -> Result<Vec<TableCell>, RepositoryError> {
        self.table.get_all()
    }
    ...
    pub fn update(
        ...
        event_buffer.push(Event {
            origin: Origin::DirectAccess(DirectAccessEntity::TableCell(EntityEvent::Updated)),
            ids: vec![updated.id],
            data: None,
        });
        Ok(updated)
    ...
    pub fn remove(
        ...
        let affected_owner_ids: Vec<EntityId> = {
            let owner_repo = repository_factory::write::create_table_repository(self.transaction)?;
            owner_repo
                .get_relationships_from_right_ids(&TableRelationshipField::Cells, &[*id])?
                .into_iter()
        ...
        event_buffer.push(Event {
            origin: Origin::DirectAccess(DirectAccessEntity::TableCell(EntityEvent::Removed)),
            ids: vec![*id],
            data: None,
        });
    ...
    pub fn remove_multi(
        ...
        let affected_owner_ids: Vec<EntityId> = {
            let owner_repo = repository_factory::write::create_table_repository(self.transaction)?;
            owner_repo
                .get_relationships_from_right_ids(&TableRelationshipField::Cells, ids)?
                .into_iter()
                .map(|(owner_id, _)| owner_id)
                .collect()
        };
    ...
    pub fn get_relationships_from_owner(
        ...
        let repo = repository_factory::write::create_table_repository(self.transaction)?;
        repo.get_relationship(owner_id, &TableRelationshipField::Cells)
    }
    ...
    pub fn set_relationships_in_owner(
        ...
        let mut repo = repository_factory::write::create_table_repository(self.transaction)?;
        repo.set_relationship(event_buffer, owner_id, &TableRelationshipField::Cells, ids)
    }
    ...
    pub fn restore(
        ...
        emit(
            DirectAccessEntity::TableCell(EntityEvent::Updated),
            table_cell_ids,
        );
...
pub struct TableCellRepositoryRO<'a> {
    table: Box<dyn TableCellTableRO + 'a>,
}
impl<'a> TableCellRepositoryRO<'a> {
    pub fn new(table: Box<dyn TableCellTableRO + 'a>) -> Self {
        TableCellRepositoryRO { table }
    }
    pub fn get(&self, id: &EntityId) -> Result<Option<TableCell>, RepositoryError> {
        self.table.get(id)
    }
