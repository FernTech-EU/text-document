...
pub struct TableRepository<'a> {
    table: Box<dyn TableTable + 'a>,
    transaction: &'a Transaction,
}

impl<'a> TableRepository<'a> {
    pub fn new(table: Box<dyn TableTable + 'a>, transaction: &'a Transaction) -> Self {
        TableRepository { table, transaction }
    }
...
pub struct TableRepositoryRO<'a> {
    table: Box<dyn TableTableRO + 'a>,
}
impl<'a> TableRepositoryRO<'a> {
    pub fn new(table: Box<dyn TableTableRO + 'a>) -> Self {
        TableRepositoryRO { table }
    }
    pub fn get(&self, id: &EntityId) -> Result<Option<Table>, RepositoryError> {
        self.table.get(id)
    }
