...
use crate::use_cases::insert_image_uc::{
    InsertImageUnitOfWorkFactoryTrait, InsertImageUnitOfWorkTrait,
};
...
// Unit of work for InsertImage

pub struct InsertImageUnitOfWork {
    context: DbContext,
...
impl InsertImageUnitOfWork {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        InsertImageUnitOfWork {
...
impl CommandUnitOfWork for InsertImageUnitOfWork {
...
impl InsertImageUnitOfWorkFactory {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        InsertImageUnitOfWorkFactory {
            context: db_context.clone(),
            event_hub: event_hub.clone(),
        }
    }
...
impl InsertImageUnitOfWorkFactoryTrait for InsertImageUnitOfWorkFactory {
    fn create(&self) -> Box<dyn InsertImageUnitOfWorkTrait> {
        Box::new(InsertImageUnitOfWork::new(&self.context, &self.event_hub))
    }
}
