...
use crate::use_cases::insert_djot_at_position_uc::{
    InsertDjotAtPositionUnitOfWorkFactoryTrait, InsertDjotAtPositionUnitOfWorkTrait,
};
...
// Unit of work for InsertDjotAtPosition

pub struct InsertDjotAtPositionUnitOfWork {
    context: DbContext,
...
impl InsertDjotAtPositionUnitOfWork {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        InsertDjotAtPositionUnitOfWork {
...
impl CommandUnitOfWork for InsertDjotAtPositionUnitOfWork {
...
//
// Exactly the same macros must be set in the use case uow trait file in ../use_cases/insert_djot_at_position_uc.rs
//
...
impl InsertDjotAtPositionUnitOfWorkTrait for InsertDjotAtPositionUnitOfWork {}

pub struct InsertDjotAtPositionUnitOfWorkFactory {
    context: DbContext,
    event_hub: Arc<EventHub>,
}

impl InsertDjotAtPositionUnitOfWorkFactory {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        InsertDjotAtPositionUnitOfWorkFactory {
            context: db_context.clone(),
            event_hub: event_hub.clone(),
        }
    }
...
impl InsertDjotAtPositionUnitOfWorkFactoryTrait for InsertDjotAtPositionUnitOfWorkFactory {
    fn create(&self) -> Box<dyn InsertDjotAtPositionUnitOfWorkTrait> {
        Box::new(InsertDjotAtPositionUnitOfWork::new(
            &self.context,
            &self.event_hub,
        ))
    }
