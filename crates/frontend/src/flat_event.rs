// Generated by Qleany v1.7.3 from frontend_flat_event.tera
...
pub enum FlatEventKind {
    ...
    DocumentEditingInsertTableColumn,
    DocumentEditingRemoveTableRow,
    ...
    fn from(event: Event) -> Self {
        let kind = match &event.origin {
            Origin::DirectAccess(da) => match da {
                ...
                DirectAccessEntity::Table(EntityEvent::Created) => FlatEventKind::TableCreated,
                DirectAccessEntity::Table(EntityEvent::Updated) => FlatEventKind::TableUpdated,
                DirectAccessEntity::Table(EntityEvent::Removed) => FlatEventKind::TableRemoved,
                DirectAccessEntity::TableCell(EntityEvent::Created) => {
                    FlatEventKind::TableCellCreated
                }
                DirectAccessEntity::TableCell(EntityEvent::Updated) => {
                    FlatEventKind::TableCellUpdated
                }
                DirectAccessEntity::TableCell(EntityEvent::Removed) => {
                    FlatEventKind::TableCellRemoved
                }
            },
            ...
            Origin::DocumentEditing(fe) => match fe {
                ...
                DocumentEditingEvent::InsertTableRow => {
                    FlatEventKind::DocumentEditingInsertTableRow
                }
                DocumentEditingEvent::InsertTableColumn => {
                    FlatEventKind::DocumentEditingInsertTableColumn
                }
                DocumentEditingEvent::RemoveTableRow => {
                    FlatEventKind::DocumentEditingRemoveTableRow
                }
                DocumentEditingEvent::RemoveTableColumn => {
                    FlatEventKind::DocumentEditingRemoveTableColumn
                }
                DocumentEditingEvent::MergeTableCells => {
                    FlatEventKind::DocumentEditingMergeTableCells
                }
            ...
            Origin::DocumentFormatting(fe) => match fe {
                ...
                DocumentFormattingEvent::SetTableFormat => {
                    FlatEventKind::DocumentFormattingSetTableFormat
                }
            ...
            Origin::DocumentSearch(fe) => match fe {
                ...
                DocumentSearchEvent::AddressableText => {
                    FlatEventKind::DocumentSearchAddressableText
                }
            },
...
mod tests {
    ...
    fn test_is_mutation() {
        ...
        assert!(is_mutation(&FlatEventKind::TableCreated));
        assert!(is_mutation(&FlatEventKind::TableUpdated));
        assert!(is_mutation(&FlatEventKind::TableRemoved));

        assert!(is_mutation(&FlatEventKind::TableCellCreated));
        assert!(is_mutation(&FlatEventKind::TableCellUpdated));
        assert!(is_mutation(&FlatEventKind::TableCellRemoved));
