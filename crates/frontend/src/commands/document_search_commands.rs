...
use document_search::{
    AddressableTextResultDto, FindAllDto, FindAllResultDto, FindResultDto, FindTextDto,
    ReplaceRangesDto, ReplaceRangesResultDto, ReplaceResultDto, ReplaceTextDto,
...
pub fn addressable_text(ctx: &AppContext) -> Result<AddressableTextResultDto> {
    document_search_controller::addressable_text(&ctx.db_context, &ctx.event_hub)
        .context("addressable_text")
}
